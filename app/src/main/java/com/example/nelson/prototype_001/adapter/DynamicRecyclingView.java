...
public class DynamicRecyclingView extends ListView {
    ...
    private static final int LINE_THICKNESS = 0;
    ...
    public DynamicRecyclingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        paint.setColor(Color.parseColor("#00a2b7"));
